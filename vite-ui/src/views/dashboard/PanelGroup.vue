    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="panelData.total" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="panelData.monthTotal" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
